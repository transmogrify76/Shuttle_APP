  ...
  const html = `
    ...
    <body>
      ...
      <div class="section">
        ...
        <div class="row"><span class="label">IGST (${invoiceData.breakdown.igst_rate_percent}%):</span><span>₹${invoiceData.breakdown.igst_amount}</span></div>
        <div class="row"><span class="label">Total Tax:</span><span>₹${invoiceData.breakdown.total_tax_amount}</span></div>
        <div class="row"><span class="label">Tax treatment:</span><span>${invoiceData.breakdown.gst_inclusive ? 'Inclusive' : 'Exclusive'}</span></div>
        ${parseFloat(invoiceData.breakdown.rounding_adjustment) !== 0
          ? `<div class="row"><span class="label">Rounding adjustment:</span><span>₹${invoiceData.breakdown.rounding_adjustment}</span></div>`
          : ''}
        <div class="row total"><span class="label">Total Booking Amount:</span><span>₹${invoiceData.breakdown.total_booking_amount}</span></div>
      </div>
